            ...
            <form className="space-y-4" onSubmit={(e) => { e.preventDefault(); handleSave(); }}>
              ...
              {editTarget && (
                <div className="flex items-center gap-3">
                  ...
                  >
                    <span
                      className={`pointer-events-none inline-block h-5 w-5 rounded-full bg-[var(--card)] shadow transition-transform ${formData.is_active ? "translate-x-5" : "translate-x-0"}`}
                    />
                  </button>
                  <span className="text-xs text-[var(--muted-foreground)]">
